...
function runthis() {
  ...
  pm.onload=receive;
  pm.src = 'https://shortcut.io/javascripts/jquery.ba-postmessage.min.js';
  document.body.appendChild(pm);

  jQuery(document.body).append(
    "<iframe id='shortcut_bookmarklet' src='https://shortcut.io/bookmarklet.html?" +
  ...
  jQuery.receiveMessage(
    function(e){
      if (e.data == "close") {
        ...
        url = "https://shortcut.io/bookmarklet.html" +
              "?auth_token=" + t +
              "#" + location.href +"' />";
